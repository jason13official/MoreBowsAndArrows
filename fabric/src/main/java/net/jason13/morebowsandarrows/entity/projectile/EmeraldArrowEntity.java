...
public class EmeraldArrowEntity extends AbstractArrow implements IAbstractModArrow {
    ...
    public EmeraldArrowEntity(Level level, LivingEntity liveEntity) {
        super((EntityType) FabricEntityTypeRegistry.EMERALD_ARROW_ENTITY, liveEntity, level);
        this.setBaseDamage(this.getBaseDamage() + 3.0);
    }

    public EmeraldArrowEntity(Level level, double x, double y, double z) {
        super((EntityType) FabricEntityTypeRegistry.EMERALD_ARROW_ENTITY, x, y, z, level);
        this.setBaseDamage(this.getBaseDamage() + 3.0);
    }

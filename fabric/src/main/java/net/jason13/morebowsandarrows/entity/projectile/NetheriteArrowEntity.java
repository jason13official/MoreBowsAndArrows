...
public class NetheriteArrowEntity extends AbstractArrow implements IAbstractModArrow {
    ...
    public NetheriteArrowEntity(Level level, LivingEntity liveEntity) {
        super((EntityType) FabricEntityTypeRegistry.NETHERITE_ARROW_ENTITY, liveEntity, level);
        this.setBaseDamage(this.getBaseDamage() + 5.0);
    }

    public NetheriteArrowEntity(Level level, double x, double y, double z) {
        super((EntityType) FabricEntityTypeRegistry.NETHERITE_ARROW_ENTITY, x, y, z, level);
        this.setBaseDamage(this.getBaseDamage() + 5.0);
    }

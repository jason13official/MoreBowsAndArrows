...
public class ObsidianArrowEntity extends AbstractArrow implements IAbstractModArrow {
    ...
    public ObsidianArrowEntity(EntityType ent, Level level) {
        super(ent, level);
        this.setBaseDamage(this.getBaseDamage() + 5.0);
    }

    public ObsidianArrowEntity(Level level, LivingEntity liveEntity) {
        super((EntityType) ForgeEntityTypeRegistry.OBSIDIAN_ARROW_ENTITY.get(), liveEntity, level);
        this.setBaseDamage(this.getBaseDamage() + 5.0);
    }

    public ObsidianArrowEntity(Level level, double x, double y, double z) {
        super((EntityType) ForgeEntityTypeRegistry.OBSIDIAN_ARROW_ENTITY.get(), x, y, z, level);
        this.setBaseDamage(this.getBaseDamage() + 5.0);
    }

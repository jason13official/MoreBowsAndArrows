    ...
    if (!arrow.level.isClientSide) {
      ...
      if (arrow.getOwner() != null) {
        for (ItemStack stack : arrow.getOwner().getHandSlots()) {
          if (this.getClass() == BambooArrowEntity.class && stack.is(ForgeItemRegistry.BAMBOO_BOW.get())) {
  ...
  default void checkArrowEntityDamage(AbstractArrow arrow, EntityHitResult hitResult) {
    ...
    if (!arrow.level.isClientSide && arrow.getOwner() != null) {
      for (ItemStack stack : arrow.getOwner().getHandSlots()) {
        ...
        if (stack.is(ForgeItemRegistry.AMETHYST_BOW.get())) {
        ...
        if (stack.is(ForgeItemRegistry.BAMBOO_BOW.get())) {
        ...
        if (stack.is(ForgeItemRegistry.BLAZE_BOW.get())) {
        ...
        if (stack.is(ForgeItemRegistry.BONE_BOW.get())) {
        ...
        if (stack.is(ForgeItemRegistry.COAL_BOW.get())) {
        ...
        if (stack.is(ForgeItemRegistry.COPPER_BOW.get())) {
        ...
        if (stack.is(ForgeItemRegistry.DIAMOND_BOW.get())) {
        ...
        if (stack.is(ForgeItemRegistry.EMERALD_BOW.get())) {
        ...
        if (stack.is(ForgeItemRegistry.GOLD_BOW.get())) {
        ...
        if (stack.is(ForgeItemRegistry.IRON_BOW.get())) {
        ...
        if (stack.is(ForgeItemRegistry.LAPIS_BOW.get())) {
        ...
        if (stack.is(ForgeItemRegistry.PAPER_BOW.get())) {
        ...
        if (stack.is(ForgeItemRegistry.MOSS_BOW.get())) {
        ...
        if (stack.is(ForgeItemRegistry.NETHERITE_BOW.get())) {
        ...
        if (stack.is(ForgeItemRegistry.OBSIDIAN_BOW.get())) {
        ...
        if (stack.is(ForgeItemRegistry.PAPER_BOW.get()) || stack.is(ForgeItemRegistry.MOSS_BOW.get())) {
